        ...
        <SheetHeader>
          ...
          <div className="flex flex-col gap-4 text-sm">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    localStorage.setItem("continuous", JSON.stringify(checked));
                  }}
                />
            ...
            <div className="flex flex-col gap-2">
              ...
              If disabled, messages will be replaced when created, and only the
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    setAutoCopy(checked);
                    localStorage.setItem("auto-copy", JSON.stringify(checked));
                  }}
                />
            ...
            <div className="flex flex-col gap-2">
              ...
              The amount of time, in seconds, that should pass between messages
